...
return [
    ...
    */
    ...
    'policies' => [
        ...
        // \App\CustomForumPolicy\ForumPolicy::class

        'forum' => \App\CustomForumPolicy\ForumPolicy::class,
        'model' => [
            TeamTeaTime\Forum\Models\Category::class => \App\CustomForumPolicy\CategoryPolicy::class,
            TeamTeaTime\Forum\Models\Thread::class => \App\CustomForumPolicy\ThreadPolicy::class,
            TeamTeaTime\Forum\Models\Post::class => \App\CustomForumPolicy\PostPolicy::class,
        ],
    ],
